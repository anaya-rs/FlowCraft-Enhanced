...
class DocumentShare(Base):
    ...
    recipient_email = Column(String, nullable=True)  # Optional for public links
    recipient_name = Column(String, nullable=True)
    access_level = Column(String, default="view")  # view, comment, edit
    share_token = Column(String, unique=True, index=True, nullable=False)  # Unique token for access
    share_link = Column(String, nullable=True)  # Public shareable link
