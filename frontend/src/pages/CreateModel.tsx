  ...
  return (
    <Layout>
      <div className="p-8 max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2 font-sans">Create Custom Model</h1>
          <p className="text-gray-300 font-sans">Design your AI processor for documents</p>
        </div>

        {/* Preset Selection */}
        <Card className="glass-card-dark border-border mb-8">
          <CardHeader>
            <CardTitle className="text-xl text-white font-sans">Choose a Preset Template</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="font-semibold text-white font-sans">{preset.title}</h3>
                    </div>
                    <p className="text-sm text-gray-400 font-sans">{preset.description}</p>
                  </div>
                );
              })}
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="glass-card-dark border-border">
              <CardHeader>
                <CardTitle className="text-xl text-white font-sans">Model Configuration</CardTitle>
              </CardHeader>
